...
FOLDER_DOWNLOAD_CONCURRENCY = int(os.environ.get("COLAB_FOLDER_DOWNLOAD_CONCURRENCY", "32"))
FOLDER_UPLOAD_CONCURRENCY = int(os.environ.get("COLAB_FOLDER_UPLOAD_CONCURRENCY", "32"))
